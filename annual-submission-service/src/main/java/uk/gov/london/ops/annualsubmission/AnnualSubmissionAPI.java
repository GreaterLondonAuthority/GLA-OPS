...
public class AnnualSubmissionAPI {
    ...
    @Autowired
    private AnnualSubmissionServiceImpl annualSubmissionService;
    ...
    @ApiOperation(value = "returns a list of years available for annual submission creation",
            notes = "returns a list of years available for annual submission creation")
    ...
    public @ResponseBody
    AnnualSubmissionEntity get(@PathVariable Integer id) {
    ...
    public @ResponseBody
    AnnualSubmissionEntity create(@Valid @RequestBody AnnualSubmissionEntity annualSubmission,
    ...
    public void update(@PathVariable Integer id, @RequestBody AnnualSubmissionEntity annualSubmission) {
    ...
    public void updateStatus(@PathVariable Integer submissionId,
                             @RequestParam AnnualSubmissionStatus status,
                             @RequestBody(required = false) String agreementText) {
    ...
    public AnnualSubmissionBlockEntity getBlock(@PathVariable Integer submissionId, @PathVariable Integer blockId) {
    ...
    @ApiOperation(value = "updates an annual submission block", notes = "updates an annual submission block")
    public AnnualSubmissionBlockEntity updateBlock(@PathVariable Integer submissionId,
                                             @PathVariable Integer blockId,
                                             @Valid @RequestBody AnnualSubmissionBlockEntity block,
                                             BindingResult bindingResult) {
    ...
    public @ResponseBody
    AnnualSubmissionEntryEntity createEntry(@PathVariable Integer submissionId,
                                      @PathVariable Integer blockId,
                                      @Valid @RequestBody AnnualSubmissionEntryEntity entry,
                                      BindingResult bindingResult) {
