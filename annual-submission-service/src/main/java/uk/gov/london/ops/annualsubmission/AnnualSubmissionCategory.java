...
public class AnnualSubmissionCategory implements Serializable {
    ...
    @SequenceGenerator(name = "annual_submission_category_seq_gen", sequenceName = "annual_submission_category_seq",
    ...
    public AnnualSubmissionCategory(String name, AnnualSubmissionType type, AnnualSubmissionStatusType status,
            AnnualSubmissionGrantType grant, boolean commentsRequired) {
        this(name, type, status, grant, commentsRequired, false);
    }

    public AnnualSubmissionCategory(String name, AnnualSubmissionType type, AnnualSubmissionStatusType status,
            AnnualSubmissionGrantType grant, boolean commentsRequired, boolean hidden) {
        this.name = name;
        this.type = type;
        this.status = status;
        this.grant = grant;
