...
public class AnnualSubmissionEntryEntity implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "annual_submission_entry_seq_gen")
    @SequenceGenerator(name = "annual_submission_entry_seq_gen", sequenceName = "annual_submission_entry_seq",
    ...
    public AnnualSubmissionEntryEntity() {
    }

    public AnnualSubmissionEntryEntity(AnnualSubmissionCategory category, Integer value, String comments) {
        this.category = category;
        this.value = value;
        this.comments = comments;
    }

    public AnnualSubmissionEntryEntity(Integer financialYear, AnnualSubmissionCategory category, Integer value, String comments) {
    ...
    public boolean equals(Object o) {
        ...
        AnnualSubmissionEntryEntity entry = (AnnualSubmissionEntryEntity) o;
