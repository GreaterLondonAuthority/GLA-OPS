...
public class AssessmentCriteriaSummary {
    ...
    public AssessmentCriteriaSummary(BigDecimal templateMaxScore, AssessmentTemplateSection sectionTemplate,
                                     AssessmentTemplateCriteria criteriaTemplate, List<Assessment> outcomeAssessments) {
        ...
        this.assessmentCriteriaList = getAssessmentCriteriaList(sectionTemplate.getId(), criteriaTemplate.getId(),
                outcomeAssessments);
    }
    ...
    private List<AssessmentCriteria> getAssessmentCriteriaList(Integer sectionTemplateId, Integer criteriaTemplateId,
    ...
    public BigDecimal getAverageScore() {
        ...
        BigDecimal sum = scoreCriteriaList.stream()
                .map(AssessmentCriteria::getScore)
