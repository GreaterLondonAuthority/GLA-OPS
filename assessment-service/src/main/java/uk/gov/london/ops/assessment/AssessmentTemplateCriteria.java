...
public class AssessmentTemplateCriteria {
    ...
    @SequenceGenerator(name = "assessment_template_criteria_seq_gen", sequenceName = "assessment_template_criteria_seq",
    ...
    public AssessmentTemplateCriteria(String title, Integer weight, Requirement commentsRequirement,
                                      CriteriaAnswerType answerType, Double displayOrder) {
        this.title = title;
        this.weight = weight;
