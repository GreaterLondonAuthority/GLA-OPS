...
public interface AssessmentSummaryRepository extends ReadOnlyRepository<AssessmentSummary, Integer>,
        QuerydslPredicateExecutor<AssessmentSummary> {

    default Page<AssessmentSummary> findAll(Set<Integer> managingOrganisationsIds,
        ...
        query.build(managingOrganisationsIds);
