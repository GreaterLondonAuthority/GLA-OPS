...
drop table if exists internal_questions_block CASCADE;
drop table if exists internal_risk_block CASCADE;
drop table if exists internal_template_block CASCADE;
drop table if exists internal_template_block_question CASCADE;
...
drop table if exists sap_id CASCADE;
...
DROP SEQUENCE IF EXISTS internal_questions_block_seq CASCADE;
DROP SEQUENCE IF EXISTS internal_questions_block_id_seq CASCADE;
