...
public class DataCleanser {
    ...
    @Autowired
    protected OrganisationBuilder organisationBuilder;
    ...
    private void removeOldData() {
        String query = "SELECT table_name  FROM information_schema.tables "
                ...
                + "and upper(table_name) != 'ORGANISATION_ENTITY_TYPE' "
    ...
    private void truncateTable(String table) {
        ...
        String query = environment.isH2Database() ? "TRUNCATE table " + table : "TRUNCATE " + table + " cascade";
        jdbcTemplate.update(query);
    }
}
