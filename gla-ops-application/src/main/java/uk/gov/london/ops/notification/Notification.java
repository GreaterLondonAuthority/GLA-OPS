...
public class Notification implements OpsEntity<Integer> {
    ...
    public Notification(NotificationType type, String text, String targetEntityId) {
        this.type = type;
    ...
    @Deprecated
    public Notification(NotificationSubType subType, String text, EntityType targetEntityType, String targetEntityId) {
