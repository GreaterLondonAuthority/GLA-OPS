...
import uk.gov.london.ops.organisation.model.OrganisationBudgetEntry;
...
public interface OrganisationBudgetEntryRepository extends JpaRepository<OrganisationBudgetEntry, Integer> {
    ...
    default OrganisationBudgetEntry findInitial(Integer organisationId, Integer programmeId, GrantType grantType,
                                                boolean strategic) {
        return findByOrganisationIdAndProgrammeIdAndTypeAndGrantTypeAndStrategic(organisationId, programmeId, Initial, grantType,
                strategic);
    }
