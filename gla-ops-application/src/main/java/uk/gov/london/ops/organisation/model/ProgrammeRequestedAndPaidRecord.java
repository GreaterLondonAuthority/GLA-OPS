...
public class ProgrammeRequestedAndPaidRecord {
    ...
    public ProgrammeRequestedAndPaidRecord(RequestedAndPaidRecord strategicRecord, RequestedAndPaidRecord nonStrategicRecord,
                                           AssociatedProjectsRecord associatedProjectsRecord,
                                           StrategicPartnershipUnitSummary strategicPartnershipUnitSummary) {
