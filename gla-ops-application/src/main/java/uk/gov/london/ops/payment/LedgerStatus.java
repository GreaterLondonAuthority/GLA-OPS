...
public enum LedgerStatus {
    ...
    public static Set<LedgerStatus> getApprovedPaymentStatuses() {
        return new HashSet<LedgerStatus>() {{
            add(Authorised);
            add(Sent);
            add(UnderReview);
            add(SupplierError);
    ...
    public static Set<LedgerStatus> getPaymentStatuses() {
        HashSet<LedgerStatus> ledgerStatuses = new HashSet<>(getApprovedPaymentStatuses());
        ledgerStatuses.add(Pending);
        ledgerStatuses.add(Declined);
        return ledgerStatuses;
    }
}
