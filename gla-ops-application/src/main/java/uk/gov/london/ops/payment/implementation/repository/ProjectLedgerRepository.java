...
//        }
    ...
    @Query(value = "select new " +
            "uk.gov.london.ops.project.SAPMetaData(p.vendorName, p.transactionDate, p.category, p.categoryId, p.sapCategoryCode, p.transactionNumber, p.value, p.ledgerSource, p.spendType) " +
