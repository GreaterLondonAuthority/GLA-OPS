...
public class InvoiceResponseMessageEndpoint {
    ...
    private void processSegment(String fileName, int segment, InvoiceDetails details, String content) {
        ...
        paymentService.setStatus(payment, status, null, content);

        recordSegmentProcessed(fileName, segment, payment, content);
    }
    ...
    void recordSegmentProcessed(String fileName, int segment, ProjectLedgerEntry payment, String content) {
        recordSapData(fileName, segment, true, null, content);
