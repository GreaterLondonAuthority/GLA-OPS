...
public class SapPaymentDataModel implements SapDataModel {
    ...
    @JacksonXmlProperty(isAttribute = true)
    private String PaymentPostingDate;
    ...
    public String getPaymentPostingDate() {
        return PaymentPostingDate;
    }

    public void setPaymentPostingDate(String paymentPostingDate) {
        PaymentPostingDate = paymentPostingDate;
    }
    ...
    public String getDate() {
        return StringUtils.defaultIfBlank(PaymentPostingDate, paymentDate);
    }
