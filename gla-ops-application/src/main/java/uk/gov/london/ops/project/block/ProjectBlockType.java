...
public enum ProjectBlockType {
    ...
    CalculateGrant("Calculate Grant", CalculateGrantTemplateBlock.class, CalculateGrantBlock.class),
    NegotiatedGrant("Negotiated Grant", NegotiatedGrantTemplateBlock.class, NegotiatedGrantBlock.class),
    DeveloperLedGrant("Developer-led Grant", DeveloperLedGrantTemplateBlock.class, DeveloperLedGrantBlock.class),
    IndicativeGrant("Indicative Grant", IndicativeGrantTemplateBlock.class, IndicativeGrantBlock.class),
    AffordableHomes("Affordable Homes", AffordableHomesTemplateBlock.class, AffordableHomesBlock.class),
    ...
    UnitDetails("Unit Details", UnitDetailsTemplateBlock.class, UnitDetailsBlock.class),
