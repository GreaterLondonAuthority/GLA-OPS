...
public class AnnualSpendSummary implements ComparableItem {
    ...
    @JsonIgnore
    private final AnnualSpendLineItem totalForPastMonths = new AnnualSpendLineItem(BigDecimal.ZERO, BigDecimal.ZERO,
            BigDecimal.ZERO, BigDecimal.ZERO);

    private final AnnualSpendLineItem totalForCurrentAndFutureMonths = new AnnualSpendLineItem(BigDecimal.ZERO, BigDecimal.ZERO,
            BigDecimal.ZERO, BigDecimal.ZERO);

    private final AnnualSpendLineItem actualSpend = new AnnualSpendLineItem(BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO,
            BigDecimal.ZERO);

    @JsonIgnore
    private final AnnualSpendLineItem remainingForecast = new AnnualSpendLineItem(BigDecimal.ZERO, BigDecimal.ZERO,
            BigDecimal.ZERO, BigDecimal.ZERO);
