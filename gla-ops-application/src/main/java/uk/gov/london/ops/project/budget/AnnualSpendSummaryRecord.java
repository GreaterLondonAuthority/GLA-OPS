...
public class AnnualSpendSummaryRecord {
    ...
    public AnnualSpendSummaryRecord(Integer financialYear, Integer projectId, Integer blockId, BigDecimal spend,
            LedgerStatus ledgerStatus, SpendType spendType, Integer year, Integer month) {
