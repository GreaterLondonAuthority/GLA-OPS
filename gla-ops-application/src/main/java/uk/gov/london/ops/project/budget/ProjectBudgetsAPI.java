...
@Api(description = "managing Spend")
public class ProjectBudgetsAPI {
    ...
    @ApiResponses(@ApiResponse(code = 400, message = "validation error", response = ApiError.class))
    public AnnualSpendSummary createAnnualSpendDetails(@PathVariable Integer id, @PathVariable Integer blockId,
            @PathVariable Integer year,
    ...
    public void createOrUpdateProjectLedgerEntry(@PathVariable Integer projectId, @PathVariable Integer blockId,
            @Valid @RequestBody ProjectLedgerItemRequest entry, BindingResult bindingResult) {
        verifyBinding("Invalid Ledger Details!", bindingResult);
    ...
    @ApiResponses(@ApiResponse(code = 400, message = "validation error", response = ApiError.class))
    public void deleteProjectLedgerEntry(@PathVariable Integer projectId, @PathVariable Integer blockId,
    ...
    @ApiResponses(@ApiResponse(code = 400, message = "validation error", response = ApiError.class))
    public AnnualSpendSummary deleteAnnualSpendRow(@PathVariable Integer id, @PathVariable Integer blockId,
            @PathVariable Integer year,
            @RequestParam Integer month, @RequestParam("actualYear") Integer actualYear, @RequestParam String entityType,
