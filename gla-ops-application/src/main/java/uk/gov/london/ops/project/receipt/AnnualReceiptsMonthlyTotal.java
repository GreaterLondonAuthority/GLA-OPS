...
public class AnnualReceiptsMonthlyTotal {
    ...
    private final List<AnnualReceiptsLineItem> breakdown = new ArrayList<>();
    ...
    public AnnualReceiptsLineItem getLineItemByCategory(String category) {
        Optional<AnnualReceiptsLineItem> optional = breakdown.stream().filter(item -> category.equals(item.getCategory()))
                .findFirst();
