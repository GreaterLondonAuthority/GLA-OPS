...
public class ProjectAction implements ComparableItem {
    ...
    List<ProjectDifference> compareWith(ProjectAction otherAction) {
        ...
        if (!Objects.equals(StringUtils.trimAllWhitespace(this.getAction()),
                StringUtils.trimAllWhitespace(otherAction.getAction()))) {
            differences.add(new ProjectDifference(this, "action"));
        }

        if (!Objects.equals(StringUtils.trimAllWhitespace(this.getOwner()),
                StringUtils.trimAllWhitespace(otherAction.getOwner()))) {
