...
public class SkillsFundingSummaryEntity {
    ...
    @SequenceGenerator(name = "skills_funding_summary_seq_gen", sequenceName = "skills_funding_summary_seq",
    ...
    public SkillsFundingSummaryEntity(Integer ukprn, Integer academicYear, Integer period, Integer actualYear,
            Integer actualMonth, String fundingLine, String source, String category, SkillsGrantType grantType,
