...
public class OutputConfigurationService {
    ...
    public List<OutputCategoryConfigurationSummary> getAllOutputCategories() {
        return outputCategoryConfigurationSummaryRepository.findAll();
    }
    ...
    public void updateOutputCategoryName(Integer id, String oldName, String newName) {
        ...
        templateProjectService.updateAssessmentsAffectedByCategoryChange(one, oldName, newName);
    }
