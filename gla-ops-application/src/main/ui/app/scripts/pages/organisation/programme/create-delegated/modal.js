    ...
    show: function (delegate, grantTypes, totals) {
      return $uibModal.open({
        ...
        controller: ['$uibModalInstance', function ($uibModalInstance) {
          ...
          this.formDataBlock = this.dataBlock;
          ...
          this.getTrackBy = function (grantTypeObj) {
            if (grantTypeObj && grantTypeObj.grantType) {
              return `${grantTypeObj.grantType}-${grantTypeObj.strategic}`;
            }
            return null;
          }
