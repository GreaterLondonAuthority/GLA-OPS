...
function FundingClaimModal($uibModal) {
  return {
    show: function (config) {
      return $uibModal.open({
        ...
        controllerAs: '$ctrl',
        animation: false,
        templateUrl: 'scripts/pages/project/funding/funding-claim-modal/fundingClaimModal.html',
        size: 'md',
        controller: [function () {
...
FundingClaimModal.$inject = ['$uibModal'];

angular.module('GLA')
  .service('FundingClaimModal', FundingClaimModal);
