...
public class OrganisationSummary implements Serializable {
    ...
    @Column(name = "default_sap_vendor_id")
    private String defaultSapVendorId;

    @Column(name = "sap_vendor_ids")
    private String sapVendorIds;
    ...
    public String getDefaultSapVendorId() {
        return defaultSapVendorId;
    }

    public void setDefaultSapVendorId(String defaultSapVendorId) {
        this.defaultSapVendorId = defaultSapVendorId;
    }

    public String getSapVendorIds() {
        return sapVendorIds;
    }

    public void setSapVendorIds(String sapVendorIds) {
        this.sapVendorIds = sapVendorIds;
    }
