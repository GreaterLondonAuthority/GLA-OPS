...
public class RequestedAndPaidRecord {
    ...
    public void setDpfRequested(Long dpfRequested) {
        this.dpfRequested = dpfRequested;
    }
    ...
    public void setRcgfRequested(Long rcgfRequested) {
        this.rcgfRequested = rcgfRequested;
    }

    public void setDpfApproved(Long dpfApproved) {
        this.dpfApproved = dpfApproved;
    }

    public void setGrantApproved(Long grantApproved) {
        this.grantApproved = grantApproved;
    }

    public void setRcgfApproved(Long rcgfApproved) {
        this.rcgfApproved = rcgfApproved;
    }

    public void setProjectRequestedTotal(Long projectRequestedTotal) {
        this.projectRequestedTotal = projectRequestedTotal;
    }

    public void setProjectApprovedTotal(Long projectApprovedTotal) {
        this.projectApprovedTotal = projectApprovedTotal;
    }

    public void setRcgfPaid(Long rcgfPaid) {
        this.rcgfPaid = rcgfPaid;
    }

    public void setDpfPaid(Long dpfPaid) {
        this.dpfPaid = dpfPaid;
    }

    public void setGrantPaid(Long grantPaid) {
        this.grantPaid = grantPaid;
    }
