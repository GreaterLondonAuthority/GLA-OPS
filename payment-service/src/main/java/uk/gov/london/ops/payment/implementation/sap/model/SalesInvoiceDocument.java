 ...
 */
@XmlRootElement(name = "Invoice", namespace = "urn:schemas-basda-org:2000:salesInvoice:xdr:3.01")
public class SalesInvoiceDocument {
    ...
    public static class InvoiceType {
        ...
        public String invoiceType = "INV";  // or "CRN" for credit note
    }
    ...
    public static class Currency {
        ...
        @XmlValue()
        public String value = "British Pounds";
    }
    ...
    public static class InvoiceLineReferences {
        ...
        public String costCentre = "WBS-GW0901.025";

        @XmlElement(name = "GeneralLedgerCode")
        public String generalLedgerCode = " 544076";
    }
    ...
    public static class Product {
        @XmlElement(name = "SuppliersProductCode")
    ...
    public static class Address {
        ...
        public String street = "14 Pier Walk";

        @XmlElement(name = "City")
        public String city = "North Greenwich";

        @XmlElement(name = "PostCode")
        public String postCode = "SE10 0ES";
    ...
    public void addLine(BigDecimal amount, String wbsCode, String generalLedgerCode, String supplierProductCode) {
        InvoiceLine line = new InvoiceLine();
        line.lineNumber = lines.size() + 1;
        line.product.supplierProductCode = supplierProductCode;
