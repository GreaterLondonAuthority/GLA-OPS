...
public enum StateModel {
    AutoApproval("Draft", null, false, false,  true, true),

    ChangeControlled("Draft", null, true, true,  false, false),

    MultiAssessment("Stage 1", "Draft", true, true,  false, false);
    ...
    StateModel(String initialStatus, String initialSubStatus, boolean approvalRequired, boolean reportOnLastApproved,
               boolean allowClosureWithUnapprovedBlocks,
            boolean allowClosureWithUnapprovedMandatoryMilestones) {
