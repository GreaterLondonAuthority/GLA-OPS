...
public class SAPMetaData {
    ...
    public SAPMetaData(String payerName, String date, String categoryCode, Integer categoryCodeId, String sapCategoryCode,
        String invoiceNumber, BigDecimal amount, LedgerSource ledgerSource, SpendType spendType) {
