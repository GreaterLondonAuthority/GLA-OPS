...
public class AnnualSubmissionBlock implements Serializable, LockableEntity {
    ...
    public boolean isComplete() {
        ...
        if (Actual.equals(statusType)) {
            ...
            if (isRolloverInterestExceeded() || isRolloverGrantExceeded()) {
                return false;
            }
        }
            ...
            if (getUnspentGrantTotal() != null && getClosingBalance() != getUnspentGrantTotal()) {
                return false;
            }
        }
    ...
    public int getClosingBalance() {
        if (closingBalance == null) {
            closingBalance = openingBalance + getTotalGenerated() - getTotalSpent();
        }
