...
public class OrganisationBudgetEntry implements OpsEntity<Integer> {
    ...
    @SequenceGenerator(name = "organisation_budget_entry_seq_gen", sequenceName = "organisation_budget_entry_seq", initialValue = 10000, allocationSize = 1)
    private Integer id;
    ...
    public OrganisationBudgetEntry(Integer organisationId, Integer programmeId, BigDecimal amount, Type type, GrantType grantType, boolean strategic) {
