...
@JoinData(sourceTable = "design_standards", sourceColumn = "id", targetTable = "project_block", targetColumn = "id", joinType = Join.JoinType.OneToOne,
...
public class DesignStandardsBlock extends NamedProjectBlock {
    ...
    public final static String MEETING_DESIGN_GUIDE_PARAM = ReportPrefix.ds_.name() + "meeting_design_guide";
    public final static String REASON_NOT_MEETING_DESIGN_GUIDE_PARAM = ReportPrefix.ds_.name() + "reason_not_meeting_design_guide";
    ...
    protected void generateValidationFailures() {
        ...
        if (this.getMeetingLondonHousingDesignGuide() == null) {
            ...
            if (this.getReasonForNotMeetingDesignGuide() == null ||
                ...
                this.addErrorMessage("Block1", "reasonForNotMeetingDesignGuide", "The reason for not meeting Design Guide is mandatory");
    ...
    protected void compareBlockSpecificContent(NamedProjectBlock other, ProjectDifferences differences) {
        ...
        if (!Objects.equals(StringUtils.trimAllWhitespace(reasonForNotMeetingDesignGuide), StringUtils.trimAllWhitespace(otherDesignStandardsBlock.reasonForNotMeetingDesignGuide))) {
