...
public class GrantSourceBlock extends NamedProjectBlock implements FundingSourceProvider {
    ...
    protected void generateValidationFailures() {
        ...
        if (!associatedProject && (grantValue == null && recycledCapitalGrantFundValue == null && disposalProceedsFundValue == null)) {
        ...
        if (this.getTotalGrantEligibility() != null) {
            if ((this.isAssociatedProject() && this.getStrategicFunding() > getTotalGrantEligibility()) || (totalFundRequested > this.getTotalGrantEligibility())) {
    ...
    public Long getTotalGrantEligibility() {
        return project == null ? null : project.getTotalGrantEligibility();
    }
