...
@JoinData(sourceTable = "internal_assessment_block", sourceColumn = "id", targetTable = "internal_project_block", targetColumn = "id", joinType = Join.JoinType.OneToOne,
...
public class InternalAssessmentBlock extends InternalProjectBlock {
    ...
    @SequenceGenerator(name = "internal_assessment_block_seq_gen", sequenceName = "internal_assessment_block_seq", initialValue = 10000, allocationSize = 1)
    private Integer id;

    @JoinData(joinType = Join.JoinType.OneToMany, sourceColumn = "id", targetColumn = "block_id", targetTable = "assessment",  comment = "")
