...
public abstract class InternalProjectBlock implements Serializable, OpsEntity<Integer>, Comparable {
    ...
    @SequenceGenerator(name = "internal_project_block_seq_gen", sequenceName = "internal_project_block_seq", initialValue = 10000, allocationSize = 1)
    private Integer id;
    ...
    public int compareTo(Object o) {
        ...
        if (o instanceof InternalProjectBlock) {
            InternalProjectBlock other = (InternalProjectBlock) o;
