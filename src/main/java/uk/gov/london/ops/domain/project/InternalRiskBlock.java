...
import uk.gov.london.ops.domain.template.InternalRiskTemplateBlock;
import uk.gov.london.ops.domain.template.InternalTemplateBlock;
import uk.gov.london.ops.domain.template.RiskRating;
...
@JoinData(sourceTable = "internal_risks_block", sourceColumn = "id", targetTable = "internal_project_block", targetColumn = "id", joinType = Join.JoinType.OneToOne,
...
public class InternalRiskBlock extends InternalProjectBlock {
    ...
    @SequenceGenerator(name = "internal_risk_block_seq_gen", sequenceName = "internal_risk_block_seq", initialValue = 10000, allocationSize = 1)
    private Integer id;
