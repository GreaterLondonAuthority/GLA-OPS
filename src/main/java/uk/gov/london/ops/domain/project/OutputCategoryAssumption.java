...
public class OutputCategoryAssumption implements OpsEntity<Integer> {
    ...
    public OutputCategoryAssumption(Integer projectId, Integer blockId, String category, String assumption, Integer year, OffsetDateTime createdOn, String createdBy) {
