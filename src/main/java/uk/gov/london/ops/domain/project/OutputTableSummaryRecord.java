...
public class OutputTableSummaryRecord implements  Comparable, ComparableItem {
    ...
    public OutputTableSummaryRecord(Integer id, Integer financialYear, Integer projectId, Integer blockId, String outputType, String category, String subcategory, OutputCategoryConfiguration.InputValueType valueType, Double forecast, Double actual, Double total) {
        this.id = id;
