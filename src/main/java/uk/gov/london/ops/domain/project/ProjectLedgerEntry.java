...
public class ProjectLedgerEntry implements OpsEntity<Integer>, ManagedEntityInterface {
    ...
    public static final Set<LedgerType> PAYMENT_LEDGER_TYPES =
            Stream.of(LedgerType.PAYMENT,LedgerType.DPF,LedgerType.RCGF).collect(Collectors.toSet());
    ...
    public ProjectLedgerEntry(final Integer projectId,
                              ...
                              final uk.gov.london.ops.domain.finance.LedgerStatus status) {
    ...
    public ProjectLedgerEntry(Project project, NamedProjectBlock block, Integer year, Integer month, uk.gov.london.ops.domain.finance.LedgerStatus ledgerStatus, LedgerType ledgerType, SpendType spendType, Integer categoryId, String category, BigDecimal value) {
        this(project.getId(), block.getId(), year, month, ledgerStatus, ledgerType, spendType, categoryId, category, value);
    }

    public ProjectLedgerEntry(Project project, NamedProjectBlock block, Integer year, Integer month, uk.gov.london.ops.domain.finance.LedgerStatus ledgerStatus, LedgerType ledgerType, SpendType spendType, Integer categoryId, BigDecimal value) {
        this(project.getId(), block.getId(), year, month, ledgerStatus, ledgerType, spendType, null, categoryId, value);
    }

    public ProjectLedgerEntry(Integer projectId, Integer blockId, Integer year, Integer month, uk.gov.london.ops.domain.finance.LedgerStatus ledgerStatus, LedgerType ledgerType, SpendType spendType, Integer categoryId, BigDecimal value) {
        this(projectId, blockId, year, month, ledgerStatus, ledgerType, spendType, null, categoryId, value);
    }

    public ProjectLedgerEntry(Integer projectId, Integer blockId, Integer year, Integer month, uk.gov.london.ops.domain.finance.LedgerStatus ledgerStatus, LedgerType ledgerType, SpendType spendType, Integer categoryId, String category, BigDecimal value) {
        this(projectId, blockId, year, month, ledgerStatus, ledgerType, spendType, category, categoryId, value);
    }

    public ProjectLedgerEntry(Integer projectId, Integer blockId, Integer year, Integer month, uk.gov.london.ops.domain.finance.LedgerStatus ledgerStatus,
    ...
    public uk.gov.london.ops.domain.finance.LedgerStatus getLedgerStatus() {
        return ledgerStatus;
    }

    public void setLedgerStatus(uk.gov.london.ops.domain.finance.LedgerStatus ledgerStatus) {
        this.ledgerStatus = ledgerStatus;
    }
