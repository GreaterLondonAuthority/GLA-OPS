...
public class ProjectRiskAndIssue implements ComparableItem {
    ...
    @JoinData(joinType = Join.JoinType.OneToOne, sourceColumn = "risk_category_id", targetColumn = "id", targetTable = "category_value",
            comment = "")
    @OneToOne
    ...
    public ProjectRiskAndIssue(Type type, String title, String description, Integer initialProbabilityRating, Integer initialImpactRating, Integer residualProbabilityRating, Integer residualImpactRating, CategoryValue riskCategory) {
        this.type = type;
        this.title = title;
    ...
    List<ProjectDifference> compareWith(ProjectRiskAndIssue otherRisk) {
        ...
        if (!Objects.equals(StringUtils.trimAllWhitespace(this.getTitle()), StringUtils.trimAllWhitespace(otherRisk.getTitle()))) {
            differences.add(new ProjectDifference(this, "title"));
        }

        if (!Objects.equals(StringUtils.trimAllWhitespace(this.getDescription()), StringUtils.trimAllWhitespace(otherRisk.getDescription()))) {
