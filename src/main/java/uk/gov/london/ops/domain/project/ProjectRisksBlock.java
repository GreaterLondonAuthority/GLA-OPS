...
@JoinData(sourceTable = "risks_block", sourceColumn = "id", targetTable = "project_block", targetColumn = "id", joinType = Join.JoinType.OneToOne,
...
public class ProjectRisksBlock extends NamedProjectBlock {
    ...
    public boolean isComplete() {
        ...
        return !project.getTemplate().isBlockPresent(ProjectBlockType.Risks) || (rating != null && ratingExplanation != null && !"".equals(ratingExplanation));
    }
    ...
    protected void compareBlockSpecificContent(NamedProjectBlock otherBlock, ProjectDifferences differences) {
        ...
        if (!Objects.equals(StringUtils.trimAllWhitespace(ratingExplanation), StringUtils.trimAllWhitespace(other.ratingExplanation))) {
