...
public class FundingActivity {
    ...
    @SequenceGenerator(name = "funding_activity_seq_gen", sequenceName = "funding_activity_seq", initialValue = 10000, allocationSize = 1)
    private Integer id;
    ...
    public FundingActivity(Integer blockId, Integer year, Integer quarter, String name, Integer externalId, String categoryDescription) {
    ...
    public ProjectLedgerEntry getLedgerEntry(SpendType spendType, String category) {
        return ledgerEntries.stream().filter(le -> Objects.equals(spendType, le.getSpendType()) && Objects.equals(category, le.getCategory()))
