...
public class FundingByYearAndQuarter extends FundingSectionTotalsWrapper {
    ...
    private Map<Integer, FundingYQYear> years = new HashMap<>();
    ...
    public class FundingYQYear extends FundingSectionTotalsWrapper {
        ...
        private Map<String, FundingYQMilestone> milestones = new HashMap<>();
        ...
        public List<FundingYQMilestone> getMilestones() {
            return milestones.values().stream().sorted(Comparator.comparing(FundingYQMilestone::getId)).collect(Collectors.toList());
        }
        ...
        protected void addActivity(FundingActivity activity) {
            ...
            if (!milestones.containsKey(activity.getCategoryDescription())) {
                milestones.put(activity.getCategoryDescription(), new FundingYQMilestone(activity.getId(), activity.getCategoryDescription()));
            }
    ...
    public class FundingYQMilestone extends FundingSectionTotalsWrapper {
        ...
        private Integer id;
        private String name;
        private Map<String, FundingYQActivity> activities = new HashMap<>();
