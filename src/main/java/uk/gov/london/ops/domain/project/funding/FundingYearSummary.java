...
public class FundingYearSummary {
    ...
    public FundingYearSummary(FundingYearSummaryID id, Integer projectId, BigDecimal revenueGrant, BigDecimal revenueMatch, BigDecimal capitalGrant, BigDecimal capitalMatch) {
        this.id = id;
