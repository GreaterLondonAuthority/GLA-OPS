 ...
 */
package uk.gov.london.ops.domain.project.state;
...
public class ProjectStateEntity {
    ...
    public ProjectStateEntity(Integer id, StateModel stateModel, String statusName, String subStatusName, ProjectStatus statusType, ProjectSubStatus subStatusType) {
        this.id = id;
