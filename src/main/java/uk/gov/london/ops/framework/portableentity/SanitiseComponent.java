...
public class SanitiseComponent {
    ...
    private Object stripIds(Object toStrip, List<Class> excludedClasses, HashSet<String> visited) {
        ...
        sanitiseIds(toStrip, toStrip.getClass().getSuperclass().getDeclaredFields(), toStrip.getClass().getSuperclass().getSimpleName(), excludedClasses, visited);

        return toStrip;
    }

    private void sanitiseIds(Object object, Field[] fields,String className, List<Class> excludedClasses, HashSet<String> visited) {
