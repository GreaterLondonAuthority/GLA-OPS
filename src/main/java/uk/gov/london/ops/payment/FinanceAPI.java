...
public class FinanceAPI {
    ...
    public String sapRead(
            ...
            @RequestParam(name = "path", defaultValue = "/Home/eP2P_Project1/GLAOPS/Outgoing/Dev/") String path) throws IOException {
    ...
    @ApiOperation(value = "create new finance category", notes = "")
    ...
    @ApiOperation(value = "edit an existing finance category", notes = "")
