...
public class MilestoneReportProfile extends BaseReportProfile {
    ...
    void populateProjectDetailsForReport(Project project,  Map<String, Object> map) {
        ...
        map.put(headerMapper.get("project_status"), getReportFieldValue(project.getStatus() +
                (project.getSubStatus() == null ? "" : " " + project.getSubStatus())));
    ...
    void extractSupplementalPaymentDetails(Map<String, Object> map, Project project, Integer extId) {
        List<ProjectLedgerEntry> supplementals = ledgerRepository.findAllByProjectIdAndCategoryAndExternalId(project.getId(), SUPPLEMENTARY_CATEGORY, extId);
    ...
    void extractPaymentDetails(Map<String, Object> map, Project project, Integer extId) {
        List<ProjectLedgerEntry> allByProjectId = ledgerRepository.findAllByProjectIdAndCategoryAndExternalId(project.getId(), MILESTONE_CATEGORY, extId);
