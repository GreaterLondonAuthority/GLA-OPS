...
public interface OrganisationGroupRepository extends JpaRepository<OrganisationGroup, Integer> {
    ...
    List<OrganisationGroup> findAllByLeadOrganisationId(Integer leadOrganisationId);

    List<OrganisationGroup> findAllByTypeAndProgrammeIdAndLeadOrganisationId(OrganisationGroup.Type type, Integer programmeId, Integer leadOrganisationId);

    List<OrganisationGroup> findAllByTypeAndProgrammeIdAndOrganisations(OrganisationGroup.Type type, Integer programmeId, Organisation organisation);
