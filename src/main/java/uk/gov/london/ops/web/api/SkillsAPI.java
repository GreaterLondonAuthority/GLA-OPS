...
@Api(description="API for managing Skills Profile Data")
public class SkillsAPI {
    ...
    public void updatePaymentProfile(@PathVariable Integer id, @RequestBody SkillsPaymentProfile profile, BindingResult bindingResult) {
    ...
    @ApiOperation(value="delete all existing payment profile entries by type and year", notes="deletes all existing skills payment profile entries by type and year")
    ...
    @ApiOperation(value = "clones a previous year data or creates new year data", notes = "clones a previous year data or creates new year data")
    ...
    @ApiOperation(value = "returns current academic year as an integer", notes = "")
