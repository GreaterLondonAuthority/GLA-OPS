...
import uk.gov.london.ops.service.project.ProjectSkillsService;
...
public class ProjectSkillsAPI {
    ...
    @RequestMapping(value = "/projects/{projectId}/learningGrant", method = RequestMethod.GET)
    @ApiOperation(value = "get a project's learning grant block", notes = "")
    public LearningGrantBlock getLearningGrant(@PathVariable Integer projectId, @RequestParam(required = false) Integer year) {
        return projectSkillsService.getLearningGrant(projectId);
    }
