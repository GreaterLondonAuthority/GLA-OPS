...
public class UserOrgFinanceThreshold {
    ...
    public UserOrgFinanceThreshold(String userName, Integer organisationId, Long approvedThreshold, Long pendingThreshold,
                                   String requesterUsername, String approverUsername) {
